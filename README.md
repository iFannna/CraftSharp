...
<h1 align="center">Craft # ( CraftSharp )</h1>
...
于是决定自己动手写一个。Craft #由此诞生 —— 不仅尽可能的还原 Minecraft HUD 的完整体验，还要在可定制性、交互体验、扩展功能等方面做得更深入，真正把 Minecraft 界面带到桌面。

## 亮点

Craft # 在 Minecraft HUD 样式高度还原的基础上，还还原了对应的交互细节并延伸出硬件映射与壁纸引擎两大方向。
...
前往 [GitHub Releases](https://github.com/iFannna/CraftSharp/releases/latest) 下载最新版本安装包，双击运行即可。

仅支持 Windows 10/11，安装包为自包含发布，无需额外安装 .NET Runtime。

## 许可证

Craft # 基于 [MIT License](LICENSE) 开源。你可以自由使用、修改和分发。
